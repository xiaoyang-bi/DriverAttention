...
class BDDADataSet(Dataset):
    def __init__(self, root: str, mode: str, alpha: float = 0.01, test_name: str = ''):
        ...
        self.p_root = '/data/zhupengfei/test/data/pseudo_labels'
        if mode == 'train':
...
if __name__ == '__main__':
    train_dataset = BDDADataSet("/data/zhupengfei/test/data/dataset", mode='train_u', alpha=0.3)
    train_dataset.__getitem__(1)
    # train_dataset.collate_fn(32)
    print(len(train_dataset))

    val_dataset = BDDADataSet("/data/zhupengfei/test/data/dataset", mode='val')
